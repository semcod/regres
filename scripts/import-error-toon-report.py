#!/usr/bin/env python3
"""
Generate compact Markdown report for TypeScript import/export errors,
including Toon-friendly code blocks per affected file.

Usage:
  python3 scripts/import-error-toon-report.py
  python3 scripts/import-error-toon-report.py --input-log .regres/typecheck.log
  python3 scripts/import-error-toon-report.py --max-files 25 --out-md .regres/import-toon.md
"""
